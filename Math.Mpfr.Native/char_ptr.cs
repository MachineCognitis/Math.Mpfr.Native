...
namespace Math.Mpfr.Native
{
    ...
    public struct char_ptr
    {
        ...
        /// <remarks>
        /// <para>
        /// When done with the string, unmanaged memory must be released with <see cref="mpfr_lib.free(char_ptr)"/> .
        /// </para>
        /// </remarks>
        public char_ptr(string str)
        {
            if (str == null) throw new ArgumentNullException("str");
            pointer = mpfr_lib.allocate((size_t)(str.Length + 1)).ToIntPtr();
